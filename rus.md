...
[главной составляющей дизайна все-ещё являются слова][2].
...
Существует множество определений понятия «брендировании». Когда речь идет о
...
брендирования. Недавно я получил значок, который вы видите на картинке ниже.
...
Это не значит что для пунктов первого списка брендирование использовать нельзя.
...
[Хороший пример брендирования от Foursquare]: img/FoursquareBeard-e1370544155711_mini-rus.png
