...
Это не значит что для пунктов первого списка брэндирование использовать нельзя.
Но если вы собираетесь это сделать, до внедрения результатов проведите их
